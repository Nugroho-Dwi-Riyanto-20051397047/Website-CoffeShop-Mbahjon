    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <h1 class="h2">Product Mbahjon</h1>
                ...
                <table class="table table-hover">
                    ...
                    ?>
                        ...
                        <td>
                        <a href="editproduct.php?id=<?php echo $row['id_menu'] ?>" class="btn btn-sm btn-primary mr-4"><i class="fas fa-edit"></i> Edit</a>
                        <a href="deleteproduct.php?id=<?php echo $row['id_menu'] ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Delete</a>
                        </td>
                        <!-- <td></td> -->
                        </tr>
                        <!-- <tr>
